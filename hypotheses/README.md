...
[Project overview](../README.md) | [Evidence register](../docs/evidence.md) | [Notation and sources](../docs/sources.md)

These pages propose meanings rather than certify translations. **Both hypotheses are low-confidence, and neither has independent semantic validation.** "Original" means formulated within this project, not proven first in the literature.
