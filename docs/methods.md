...
Software tests check parser behavior, quantity decoding, explicit exclusions, probability calculations, and recorded invariants. They do not certify ancient readings, demonstrate linguistic priority, or constitute peer review.
