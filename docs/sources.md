...
The reassessment and responsibility meanings are this project's conjectures, **not translations supplied by those sources**. They are not currently preferred readings, have not been validated, and have not been shown to be first in the literature. See the [review](review.md).
